					...
					<section class="feature">
						...
						<article>
							<div class="feature-high">
								<h1>Arcade</h1>
								<?php
								$reponse = $bdd->query('SELECT TOP 5* FROM jeux_video WHERE etat = arcade'); 
						...
						<article>
							<div class="feature-high">
								<h1>FPS</h1>
								<?php
								$reponse = $bdd->query('SELECT TOP 5* FROM jeux_video WHERE etat = fps'); 
								while ($donnees = $reponse->fetch()) // On parcourt la table et on affiche tous les résultats
								{   
								?>
								<div class="cover iblock">
						...
						<article>
							<div class="feature-high">
								<h1>Stratégie</h1>
								<?php
								$reponse = $bdd->query('SELECT TOP 5* FROM jeux_video WHERE etat = strategie'); 
								while ($donnees = $reponse->fetch()) // On parcourt la table et on affiche tous les résultats
								{   
								?>
								<div class="cover iblock">
						...
						<article>
							<div class="feature-high">
								<h1>Sport</h1>
								<?php
								$reponse = $bdd->query('SELECT TOP 5* FROM jeux_video WHERE etat = sport'); 
								while ($donnees = $reponse->fetch()) // On parcourt la table et on affiche tous les résultats
								{   
								?>
								<div class="cover iblock">
